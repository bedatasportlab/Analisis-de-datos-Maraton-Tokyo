...
Vamos a realizar el correspondiente tratamiento de los **valores nulos**, como bien hemos adelantado en la sección @sec-valores-nulos, los datos faltantes correspondientes a las variables de *Nombre* y *Nacionalidad* ni se imputarán ni se eliminarán dichas filas. 
...
Observamos que, en principio, los errores están completamente corregidos. Para ver si los nuevos nombres estandarizados están correctamente, vamos a cruzar los países recién creados con un conjunto de datos muy usado para realizar luego mapas geográficos con la librería [Plotly](https://plotly.com/r).
...
El boxplot muestra que la mayoría de las edades de los corredores están concentradas entre aproximadamente 39 y 55 años. La mediana (línea dentro de la caja) está cerca del centro de la caja, lo que indica una distribución mas o menos simétrica de las edades. Los bigotes del boxplot indican que no hay valores extremadamente alejados del rango intercuartílico, lo que sugiere una distribución relativamente homogénea de las edades.
